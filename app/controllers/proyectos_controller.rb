class ProyectosController < ApplicationController
  ...
  def show
    @linea1 = "EMPRESA: " + @proyecto.empresa.nombre
    @linea2 = "PROYECTO: " + @proyecto.nombre.upcase
  end
  ...
  private
    ...
    def proyecto_params
      params.require(:proyecto).permit(:empresa_id, :nombre, :description, :comitente, :lider, :fcierre, :logofile, :eproyecto)
    end
end
