class HitosController < ApplicationController
  ...
  def destroy
    @hito.destroy
    respond_to do |format|
      format.html { redirect_to hitos_url, notice: 'Hito was successfully destroyed.' }
  ...
  private
    ...
    def hito_params
      params.require(:hito).permit(:proyecto_id, :nombre, :description, :ffin, :responsable_id, :thito, :ehito, :privada)
    end
end
